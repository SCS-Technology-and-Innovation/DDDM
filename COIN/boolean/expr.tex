\documentclass[aspectratio=169,xcolor={dvipsnames,rgb}]{beamer}
...
% https://github.com/st--/annotate-equations/blob/main/examples/demo_manual_annotate_beamer.tex#L55
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \onslide<17-18,34-35>{\fill [fill=ci] (-1.2, 0.1) rectangle (7, 5);}     
      \onslide<13-15,32-35>{\fill [fill=cn] (-1, 2.5) rectangle (4.8, 4.7);}      
